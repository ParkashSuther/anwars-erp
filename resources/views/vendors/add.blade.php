                            ...
                            <div class="col-sm-12">
                               ...
                               <div class="col-md-6">
                                 ...
                                 <div class="form-group">
                                            ...
                                            <div class="col-sm-2">
                                          <select class="form-control" id="source">                                            
                                                  <option value="AK">+91</option>
                                                  <option value="HI">+92</option>
                                                   <option value="AK">+93</option>
                                                  <option value="HI">+94</option>
                                                  <option value="AK">+95</option>
                                                  <option value="HI">+96</option>
                                                  <option value="AK">+97</option>
                                                  <option value="HI">+98</option>
                                                  <option value="AK">+99</option>
                               ...
                               <div class="col-md-6">
                                 ...
                                 <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <textarea style="width: 100% ;height: 80px" placeholder="Enter Address"></textarea>
                                            </div>
                                 </div>
                                 ...
                                 <div class="col-sm-6 col-sm-offset-3 float-left">
                                   <div class="text-center">
                                      ...
                                      <button class="btn-info btn">Add Vendor</button>
                                  </div>
                                 </div>
                       </form>
